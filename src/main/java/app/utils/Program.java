...
public static void main(String args[]) {
	...
	Organisation org=new Organisation("Estate", "estate@estate.com", "Kigali,Rwanda", "E state is an organisation which have the apartment for rent");
	...
	Property property=new Property("Kigali Apartment","Kigali Apartment is apartemnt located in Gasabo district it is know for its good service", "Gasabo", 300,agent1,user1);
